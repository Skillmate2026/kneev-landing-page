    ...
    <section className="py-10 md:py-16 px-4 bg-[#1A332F] text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-10">
          <button onClick={() => onBook("why_choose_kneev")} className="inline-flex items-center gap-2 bg-[#E97724] text-white font-bold text-sm md:text-base px-7 py-3.5 rounded-full shadow-lg hover:bg-[#d66a1d] transition-all">
